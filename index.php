  ...
  <div class="content-sidebar col-off-4 col-lg-4 col-sm-12 col-xs-12">
    <div class="dah-sidebar">
      <div class="sidebar-content">
        ...
        <img class="table-gambar" src="media/album/urmila1.jpg" width="360px" height="200px">
        <img class="table-gambar" src="media/album/urmila2.jpg" width="500px" height="200px">
       <img class="table-gambar" src="media/album/urmila3.jpg" width="350px" height="220px">
       <img class="table-gambar" src="media/album/urmila4.jpg" width="360px" height="200px">
      </div>
    </div>
  </div>
  </div>
